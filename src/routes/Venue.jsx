...
const Venue = () => {
    ...
    return (
        <VenueContainerStyles>
            <VenuesTitleStyles variant={"h3"}>Musical Venues of Chattanooga</VenuesTitleStyles>
            <VenueListStyles>
                ...
                <VenueCard onClick={() => onClick("soldier")}>
                    ...
                    <TextStyles component='p'>Soldiers and Sailors Memorial Auditorium</TextStyles>
                </VenueCard>
